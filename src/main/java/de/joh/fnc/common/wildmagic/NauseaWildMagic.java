...
/**
 * Makes the target of wild magic dizzy for 30s
 * @author Joh0210
 */
public class NauseaWildMagic extends WildMagicPotionEffect {
    /**
     ...
     */
    public NauseaWildMagic(@NotNull ResourceLocation registryName, int frequency, boolean targetsCaster) {
        super(registryName, frequency, targetsCaster, 600, 1);
    }
