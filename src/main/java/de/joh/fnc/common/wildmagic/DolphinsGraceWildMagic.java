 ...
 * @author Joh0210
 */
public class DolphinsGraceWildMagic extends WildMagicMCPotionEffect {
    public DolphinsGraceWildMagic(@NotNull ResourceLocation registryName, int frequency) {
        super(registryName, frequency, true, MobEffects.DOLPHINS_GRACE, 6000, 2);
    }
