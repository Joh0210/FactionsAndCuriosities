...
/**
 * Maximises all Modifiers of a spell (except Delay) for 5 min.
 * <br> The target must be a Player and an M&A magician
 * @see MaximizedMobEffect
 * @see MagicEventHandler
 * @author Joh0210
 */
public class MaximizeWildMagic extends WildMagicPotionEffect {
    /**
     ...
     */
    public MaximizeWildMagic(@NotNull ResourceLocation registryName, int frequency, boolean targetsCaster) {
    ...
    public @NotNull MobEffect getMobEffect() {
        return EffectInit.MAXIMIZED.get();
    }
