 ...
 * @author Joh0210
 */
public class PoisonWildMagic extends WildMagicPotionEffect {
    /**
     ...
     */
    public PoisonWildMagic(@NotNull ResourceLocation registryName, int frequency, boolean targetsCaster, int durationMod) {
