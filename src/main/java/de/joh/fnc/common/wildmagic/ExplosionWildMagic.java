...
public class ExplosionWildMagic extends WildMagicCOT {
     ...
     */
    public ExplosionWildMagic(@NotNull ResourceLocation registryName, int frequency, boolean targetsCaster, int strength, boolean breaksBlocks, boolean spareSource) {
     ...
     * @param breaksBlocks  Does the explosion break blocks, if {@link GameRules#RULE_MOBGRIEFING} = true?
     */
    public ExplosionWildMagic(@NotNull ResourceLocation registryName, int frequency, boolean targetsCaster, int strength, boolean breaksBlocks) {
