 ...
 * @author Joh0210
 */
public class WildMagicOtherPotionEffect extends WildMagicPotionEffect {
     ...
     */
    public WildMagicOtherPotionEffect(@NotNull ResourceLocation registryName, int frequency, boolean targetsCaster, RegistryObject<MobEffect> effect, int duration, int level) {
     ...
     */
    public WildMagicOtherPotionEffect(@NotNull ResourceLocation registryName, int frequency, boolean targetsCaster, RegistryObject<MobEffect> effect, int duration, int level, boolean extremismQuality, boolean extremeOnlyNotHarmful) {
