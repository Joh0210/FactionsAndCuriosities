 ...
 * @author Joh0210
 */
public class WildMagicWaterBreathing extends WildMagicMCPotionEffect {
    public WildMagicWaterBreathing(@NotNull ResourceLocation registryName, int frequency, boolean targetsCaster) {
