...
public class WildMagicRemoveEffects extends WildMagicCOT {
    /**
     ...
     */
    public WildMagicRemoveEffects(@NotNull ResourceLocation registryName, int frequency, boolean targetsCaster) {
