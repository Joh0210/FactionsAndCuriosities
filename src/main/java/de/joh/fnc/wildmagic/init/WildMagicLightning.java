 ...
 * @author Joh0210
 */
public class WildMagicLightning extends WildMagicCOT {
    /**
     ...
     */
    public WildMagicLightning(@NotNull ResourceLocation registryName, int frequency, boolean targetsCaster) {
    ...
    protected void performWildMagic(@NotNull LivingEntity source, @Nullable SpellTarget target) {
        ...
        lightningbolt.setPos(pos.x + 0.5D, pos.y, pos.z);
