 ...
 * @author Joh0210
 */
public class WildMagicArmored extends WildMagicCOT {
     ...
     */
    public WildMagicArmored(@NotNull ResourceLocation registryName, int frequency, boolean targetsCaster, Type type) {
