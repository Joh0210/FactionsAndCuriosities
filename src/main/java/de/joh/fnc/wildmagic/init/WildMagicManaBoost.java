 ...
 * @author Joh0210
 */
public class WildMagicManaBoost extends WildMagicOtherPotionEffect {
    public WildMagicManaBoost(@NotNull ResourceLocation registryName, int frequency, int level) {
