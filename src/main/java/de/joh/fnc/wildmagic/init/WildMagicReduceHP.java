 ...
 */
public class WildMagicReduceHP extends WildMagicCOT {
     ...
     */
    public WildMagicReduceHP(@NotNull ResourceLocation registryName, int frequency, boolean targetsCaster, float percentage, int maxDamage) {
