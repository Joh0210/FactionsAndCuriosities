...
public class WildMagicFire extends WildMagicCOT {
    /**
     ...
     */
    public WildMagicFire(@NotNull ResourceLocation registryName, int frequency, boolean targetsCaster, int duration) {
