 ...
 * @author Joh0210
 */
public class WildMagicNausea extends WildMagicPotionEffect {
    /**
     ...
     */
    public WildMagicNausea(@NotNull ResourceLocation registryName, int frequency, boolean targetsCaster) {
