 ...
 * @author Joh0210
 */
public class WildMagicWateryGrave extends WildMagicPotionEffect {
    public WildMagicWateryGrave(@NotNull ResourceLocation registryName, int frequency, boolean targetsCaster) {
