 ...
 * @author Joh0210
 */
public class WildMagicHunger extends WildMagicCOT {
    /**
     ...
     */
    public WildMagicHunger(@NotNull ResourceLocation registryName, int frequency, boolean targetsCaster, boolean emptyHunger) {
