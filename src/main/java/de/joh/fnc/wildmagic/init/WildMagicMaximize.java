 ...
 * @author Joh0210
 */
public class WildMagicMaximize extends WildMagicPotionEffect {
    /**
     ...
     */
    public WildMagicMaximize(@NotNull ResourceLocation registryName, int frequency, boolean targetsCaster) {
