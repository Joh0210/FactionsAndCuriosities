...
public class WildMagicInit {
    ...
    static {
        ...
        WildMagicInit.ARMORED_DIAMOND_SELF = new WildMagicArmored(RLoc.create("wildmagic/armored_diamond_self"), 1, true, WildMagicArmored.Type.DIAMOND);
        WildMagicInit.ARMORED_DIAMOND_TARGET = new WildMagicArmored(RLoc.create("wildmagic/armored_diamond_target"), 1, false, WildMagicArmored.Type.DIAMOND);
        WildMagicInit.ARMORED_GOLD_SELF = new WildMagicArmored(RLoc.create("wildmagic/armored_gold_self"), 6, true, WildMagicArmored.Type.GOLD);
        WildMagicInit.ARMORED_GOLD_TARGET = new WildMagicArmored(RLoc.create("wildmagic/armored_gold_target"), 6, false, WildMagicArmored.Type.GOLD);
        WildMagicInit.ARMORED_IRON_SELF = new WildMagicArmored(RLoc.create("wildmagic/armored_iron_self"), 3, true, WildMagicArmored.Type.IRON);
        WildMagicInit.ARMORED_IRON_TARGET = new WildMagicArmored(RLoc.create("wildmagic/armored_iron_target"), 3, false, WildMagicArmored.Type.IRON);
        ...
        WildMagicInit.BLINDNESS_SELF = new WildMagicBlindness(RLoc.create("wildmagic/blindness_self"), 2, true);
        WildMagicInit.BLINDNESS_TARGET = new WildMagicBlindness(RLoc.create("wildmagic/blindness_target"), 4, false);
        WildMagicInit.CHRONO_ANCHOR_SELF = new WildMagicChronoAnchor(RLoc.create("wildmagic/chrono_anchor_self"), 2);
        WildMagicInit.DOLPHINS_GRACE_SELF = new WildMagicDolphinsGrace(RLoc.create("wildmagic/dolphins_grace_self"), 7);
        WildMagicInit.DOUBLE_TROUBLE = new WildMagicDoubleTrouble(RLoc.create("wildmagic/double_truble"), 4);
        WildMagicInit.ELDRIN_SIGHT_SELF = new WildMagicEldrinSight(RLoc.create("wildmagic/eldrin_sight_self"), 3);
        WildMagicInit.EMPOWERED_III_SELF = new WildMagicEmpowered(RLoc.create("wildmagic/empowered_iii_self"), 1, true, 3);
        WildMagicInit.EMPOWERED_III_TARGET = new WildMagicEmpowered(RLoc.create("wildmagic/empowered_iii_target"), 1, false, 3);
        WildMagicInit.EMPOWERED_II_SELF = new WildMagicEmpowered(RLoc.create("wildmagic/empowered_ii_self"), 2, true, 2);
        WildMagicInit.EMPOWERED_II_TARGET = new WildMagicEmpowered(RLoc.create("wildmagic/empowered_ii_target"), 2, false, 2);
        WildMagicInit.EMPOWERED_I_SELF = new WildMagicEmpowered(RLoc.create("wildmagic/empowered_i_self"), 4, true, 1);
        WildMagicInit.EMPOWERED_I_TARGET = new WildMagicEmpowered(RLoc.create("wildmagic/empowered_i_target"), 4, false, 1);
        ...
        WildMagicInit.EXPLODE_SPARE_SELF = new WildMagicExplosion(RLoc.create("wildmagic/explode_spare_self"), 5, true, 8, false, true);
        WildMagicInit.EXPLODE_SPARE_TARGET = new WildMagicExplosion(RLoc.create("wildmagic/explode_spare_target"), 4, false, 8, false, true);
        WildMagicInit.EXPLODE_STRONG_SELF = new WildMagicExplosion(RLoc.create("wildmagic/explode_strong_self"), 1, true, 4, false);
        WildMagicInit.EXPLODE_STRONG_TARGET = new WildMagicExplosion(RLoc.create("wildmagic/explode_strong_target"), 3, false, 4, false);
        WildMagicInit.EXPLODE_WEAK_SELF = new WildMagicExplosion(RLoc.create("wildmagic/explode_weak_self"), 4, true, 2, false);
        WildMagicInit.EXPLODE_WEAK_TARGET = new WildMagicExplosion(RLoc.create("wildmagic/explode_weak_target"), 5, false, 2, false);
        //WildMagicInit.EXPLODE_FAKE_SELF = new WildMagicExplosion(RLoc.create("wildmagic/explode_fake_self"), 7, true, 0, false);
        WildMagicInit.FIRE_10_SELF = new WildMagicFire(RLoc.create("wildmagic/fire_10_self"), 3, true, 10);
        WildMagicInit.FIRE_10_TARGET = new WildMagicFire(RLoc.create("wildmagic/fire_10_target"), 3, false, 10);
        WildMagicInit.FIRE_15_SELF = new WildMagicFire(RLoc.create("wildmagic/fire_15_self"), 2, true, 15);
        WildMagicInit.FIRE_15_TARGET = new WildMagicFire(RLoc.create("wildmagic/fire_15_target"), 2, false, 15);
        WildMagicInit.FIRE_20_SELF = new WildMagicFire(RLoc.create("wildmagic/fire_20_self"), 1, true, 20);
        WildMagicInit.FIRE_20_TARGET = new WildMagicFire(RLoc.create("wildmagic/fire_20_target"), 1, false, 20);
        WildMagicInit.FIRE_5_SELF = new WildMagicFire(RLoc.create("wildmagic/fire_5_self"), 5, true, 5);
        WildMagicInit.FIRE_5_TARGET = new WildMagicFire(RLoc.create("wildmagic/fire_5_target"), 5, false, 5);
        ...
        WildMagicInit.HALF_LIVE_SELF = new WildMagicReduceHP(RLoc.create("wildmagic/half_live_self"), 1, true, 0.5f, 50);
        WildMagicInit.HALF_LIVE_TARGET = new WildMagicReduceHP(RLoc.create("wildmagic/half_live_target"), 1, false, 0.5f, 50);
        WildMagicInit.HEAL_SELF = new WildMagicHeal(RLoc.create("wildmagic/heal_self"), 4, true);
        WildMagicInit.HEAL_TARGET = new WildMagicHeal(RLoc.create("wildmagic/heal_target"), 3, false);
        WildMagicInit.HUNGER_EMPTY_SELF = new WildMagicHunger(RLoc.create("wildmagic/hunger_empty_self"), 5, true, true);
        WildMagicInit.HUNGER_EMPTY_TARGET = new WildMagicHunger(RLoc.create("wildmagic/hunger_empty_target"), 5, false, true);
        WildMagicInit.HUNGER_REFILL_SELF = new WildMagicHunger(RLoc.create("wildmagic/hunger_refill_self"), 5, true, false);
        WildMagicInit.HUNGER_REFILL_TARGET = new WildMagicHunger(RLoc.create("wildmagic/hunger_refill_target"), 5, false, false);
        ...
        WildMagicInit.LIGHTNING_SELF = new WildMagicLightning(RLoc.create("wildmagic/lightning_self"), 2, true);
        WildMagicInit.LIGHTNING_TARGET = new WildMagicLightning(RLoc.create("wildmagic/lightning_target"), 4, false);
        WildMagicInit.LIVING_BOMB_SELF = new WildMagicLivingBomb(RLoc.create("wildmagic/living_bomb_self"), 2, true, 1);
        WildMagicInit.LIVING_BOMB_TARGET = new WildMagicLivingBomb(RLoc.create("wildmagic/living_bomb_target"), 2, false, 1);
        WildMagicInit.MANA_BOOST_II_SELF = new WildMagicManaBoost(RLoc.create("wildmagic/mana_boost_ii_self"), 1, 5);
        WildMagicInit.MANA_BOOST_I_SELF = new WildMagicManaBoost(RLoc.create("wildmagic/mana_boost_i_self"), 3, 2);
        WildMagicInit.MAXIMIZED_SELF = new WildMagicMaximize(RLoc.create("wildmagic/maximize_self"), 4, true);
        WildMagicInit.MAXIMIZED_TARGET = new WildMagicMaximize(RLoc.create("wildmagic/maximize_target"), 4, false);
        WildMagicInit.MINIMIZED_SELF = new WildMagicMinimize(RLoc.create("wildmagic/minimize_self"), 3, true);
        WildMagicInit.MINIMIZED_TARGET = new WildMagicMinimize(RLoc.create("wildmagic/minimize_target"), 3, false);
        WildMagicInit.NAUSEA_SELF = new WildMagicNausea(RLoc.create("wildmagic/nausea_self"), 4, true);
        WildMagicInit.NAUSEA_TARGET = new WildMagicNausea(RLoc.create("wildmagic/nausea_target"), 4, false);
        WildMagicInit.POISON_STRONG_SELF = new WildMagicPoison(RLoc.create("wildmagic/poison_strong_self"), 1, true, 2);
        WildMagicInit.POISON_STRONG_TARGET = new WildMagicPoison(RLoc.create("wildmagic/poison_strong_target"), 2, false, 2);
        WildMagicInit.POISON_WEAK_SELF = new WildMagicPoison(RLoc.create("wildmagic/poison_weak_self"), 4, true, 1);
        WildMagicInit.POISON_WEAK_TARGET = new WildMagicPoison(RLoc.create("wildmagic/poison_weak_target"), 3, false, 1);
        WildMagicInit.QUARTER_LIVE_SELF = new WildMagicReduceHP(RLoc.create("wildmagic/quarter_live_self"), 3, true, 0.25f, 50);
        WildMagicInit.QUARTER_LIVE_TARGET = new WildMagicReduceHP(RLoc.create("wildmagic/quarter_live_target"), 3, false, 0.25f, 50);
        WildMagicInit.RANDOM_ORE_MINER = new WildMagicRandomOreMiner(RLoc.create("wildmagic/random_ore_miner_self"), 6);
        WildMagicInit.RANDOM_TP_SELF = new WildMagicRandomTp(RLoc.create("wildmagic/random_tp_self"), 4, 32, true);
        WildMagicInit.RANDOM_TP_TARGET = new WildMagicRandomTp(RLoc.create("wildmagic/random_tp_target"), 5, 32, false);
        WildMagicInit.REGENERATION_SELF = new WildMagicRegeneration(RLoc.create("wildmagic/regeneration_self"), 2, false);
        WildMagicInit.REGENERATION_TARGET = new WildMagicRegeneration(RLoc.create("wildmagic/regeneration_target"), 1, false);
        WildMagicInit.REMOVE_EFFECTS_SELF = new WildMagicRemoveEffects(RLoc.create("wildmagic/remove_effects_self"), 5, true);
        WildMagicInit.REMOVE_EFFECTS_TARGET = new WildMagicRemoveEffects(RLoc.create("wildmagic/remove_effects_target"), 5, false);
        WildMagicInit.REPAIR_SELF = new WildMagicRepair(RLoc.create("wildmagic/repair_self"), 2);
        ...
        WildMagicInit.SPELL_ADJUSTMENT = new WildMagicRandomSpellAdjustment(RLoc.create("wildmagic/random_spell_adjustment_self"), 9);
        ...
        WildMagicInit.TIME_DAY = new WildMagicTime(RLoc.create("wildmagic/time_day"), 1, true);
        WildMagicInit.TIME_NIGHT = new WildMagicTime(RLoc.create("wildmagic/time_night"), 1, false);
        ...
        WildMagicInit.WATERY_GRAVE_SELF = new WildMagicWateryGrave(RLoc.create("wildmagic/watery_grave_self"), 2, true);
        WildMagicInit.WATERY_GRAVE_TARGET = new WildMagicWateryGrave(RLoc.create("wildmagic/watery_grave_target"), 5, false);
        ...
        WildMagicInit.WEATHER_RAIN = new WildMagicWeather(RLoc.create("wildmagic/weather_rain"), 1, true, false);
        WildMagicInit.WEATHER_STORM = new WildMagicWeather(RLoc.create("wildmagic/weather_storm"), 1, true, true);
        WildMagicInit.WEATHER_SUNSHINE = new WildMagicWeather(RLoc.create("wildmagic/weather_sunshine"), 1, false, false);
        WildMagicInit.WITHER_STRONG_SELF = new WildMagicWither(RLoc.create("wildmagic/wither_strong_self"), 1, true, 2);
        WildMagicInit.WITHER_STRONG_TARGET = new WildMagicWither(RLoc.create("wildmagic/wither_strong_target"), 2, false, 2);
        WildMagicInit.WITHER_WEAK_SELF = new WildMagicWither(RLoc.create("wildmagic/wither_weak_self"), 4, true, 1);
        WildMagicInit.WITHER_WEAK_TARGET = new WildMagicWither(RLoc.create("wildmagic/wither_weak_target"), 3, false, 1);
    }
}
