 ...
 * @author Joh0210
 */
public class SpellAdjustmentEmpowered extends SpellAdjustment {
    /**
     ...
     */
    public SpellAdjustmentEmpowered(@NotNull ResourceLocation registryName, int frequency, int strength) {
